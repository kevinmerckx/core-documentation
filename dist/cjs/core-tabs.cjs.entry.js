...
class CoreTabs {
    ...
    render() {
        ...
        return [
            __chunk_1.h("ol", null, this.myTabs.map(tab => __chunk_1.h("li", { class: selectedTab === tab ? 'active' : '', onClick: this.onClickFn(tab) }, tab))),
            __chunk_1.h("div", { class: 'content' }, __chunk_1.h("slot", null))
        ];
    }
    getSelectedTab() {
